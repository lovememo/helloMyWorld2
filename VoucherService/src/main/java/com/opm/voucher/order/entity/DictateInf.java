...
public class DictateInf {

	private String dictateNo;
	...
	public String getDictateNo() {
		return dictateNo;
	}
	public void setDictateNo(String dictateNo) {
	...
	public String toString() {
		return "DictateInf [dictateNo=" + dictateNo + ", orderType=" + orderType + "]";
	}
